...
public class Check {
	...
	//chi^2
	seuilChi = 0.0;//3.84;//10.83;//3.84//0;//6.64;
	seuilQ = 0;
	p = new double[2][2];
	o = new double[2][2];
	//clos
     ...
     * not dominated
     */
    public void computeSkyline(CC pattern, Vector<CC> skyline, BitSet motif, Vector<BitSet> skylineMotif, List<Integer> parentIds) {
	//if(dominateAll(pattern, skyline, skylineMotif)) {
	    ...
	    tmp.parentIds=parentIds; // for Twitter vizu
